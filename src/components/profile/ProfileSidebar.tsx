...
export function ProfileSidebar({ isSidebarOpen = false, onToggleSidebar }: ProfileSidebarProps = {}) {
  ...
  return (
    <aside className={`fixed top-16 left-0 h-[calc(100vh-4rem)] w-64 flex-shrink-0 bg-gray-50 border-r border-gray-200 z-40 transition-transform duration-500 overflow-y-auto ${
